...
# İndirme açılış sayfası (auth'suz, /indir + /download). Meta reklamlarında
# doğrudan App Store linki hedef gösterilemediği için reklamın hedefi burasıdır;
# ayrıca ?src= etiketiyle tıklama atribüsyonu sağlar.
